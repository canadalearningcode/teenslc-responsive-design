...
Preview slides: https://ladieslearningcode.github.io/teenslc-responsive-design/slides.html

### Attributions

Content created by [Emily Porta](https://twitter.com/agentemily) and [Christina Truong](https://twitter.com/christinatruong) for [Canada Learning Code](https://www.canadalearningcode.ca/).
...
Contributions by Jesse R Mykolyn and Stacie DaPonte.
...
"Please note that this is not a [Canada Learning Code](https://www.canadalearningcode.ca/) affiliated event, but we want to acknowledge the organization for the creation of [the content](https://github.com/ladieslearningcode/teenslc-responsive-design) being delivered under Creative Commons license"
